package mx.edu.utez.preparacion.Modelo;

import mx.edu.utez.platillo.modelo.PlatilloDao;
    ...
    public List getPreparacion() throws SQLException {
        ...
        try{
            ...
            while(rs.next()){
                ...
                preparacion.setIdPlatillo(precioDao.getPlatilloById(rs.getInt(2)));
    ...
    public Preparacion getPreparacionById(int id) throws SQLException{
        ...
        try{
            ...
            while(rs.next()){
                ...
                preparacion.setIdPreparacion(rs.getInt(1));
                preparacion.setDescripcion(rs.getString(2));
                preparacion.setIdPlatillo(precioDao.getPlatilloById(rs.getInt(3)));
            }
            if(con!=null) con.close();
            if(rs!=null)rs.close();
            if(ps!=null)ps.close();
